...
To calculate the probability of one certain observation being included in a bootstrap set, the answer would be [1 - P(not included)^(bootstrap size)], in this case P = 1 - 1/100, bootstrap size (sample 1:100) equal to the original data size (number 1 to 100). 
...
cat("SE (bootstrap): ", round(se_med_bootstrap,4))
```
